...
import "https://github.com/SungJunEun/Solidity_Practice/blob/main/UniswapV2/libraries/Math.sol";
import "https://github.com/SungJunEun/Solidity_Practice/blob/main/UniswapV2/Interface/IUniswapV2Callee.sol";
...
contract MyContract is UniswapV2ERC20 {
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        // in v0.8.0, overflow & underflow is reverted automatically
        // block.timestamp : timestamp of current block in seconds since epoch
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        uint balance0Adjusted = 1000 * balance0 - 3 * amount0In;
        uint balance1Adjusted = 1000 * balance1 - 3 * amount1In;
